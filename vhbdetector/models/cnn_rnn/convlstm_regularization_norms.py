...
class CONVLSTM_REGR(BaseModel):
    """It supports l1 and l2 regularization and provides more flexibility than our other cnn-rnn implemented models. It also has the advantage of Batch Normalization.
   ...
   """
    ...
    def __init__(self, convolutions_activation = "tanh", recurrent_activation = "hard_sigmoid", time_distributed_drop_rate = 0.2, convolutions_drop_rate = 0.1, recurrent_drop_rate = 0.1,  regularization = "l2", regularization_penalty = 0.001, num_convlstm_layers = 4, use_batch_norm = True):
        # Layer parameters
    ...
    def validate_params(self):
        ...
        elif self.num_convlstm_layers < 1:
            raise Exception("Failed to load the model! Please input valid number of layers.")
        elif self.regularization not in regularization_types:
    ...
    def create_model(self, X_train, Y_train, X_val, Y_val):
        ...
        num_convlstm_layers = self.num_convlstm_layers
        ...
        ########################################################################################################################
        for i in range(0, num_convlstm_layers - 1):
...
if __name__ == "__main__":
    ...
    model = CONVLSTM_REGR(convolutions_drop_rate=0.2, recurrent_drop_rate=0.2, time_distributed_drop_rate=0.3)
